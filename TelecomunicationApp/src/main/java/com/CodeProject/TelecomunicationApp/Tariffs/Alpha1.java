...
public class Alpha1 implements Tariff {

    private final double priceRoaming = 2;
    private final double normalPrice = 1;
    private final double priceAtNight = 0.5;
    ...
    @Autowired
    public Alpha1(com.CodeProject.TelecomunicationApp.Repos.chargingRepository chargingRepository , CdrRepository cdrRepository) {
    ...
    public ChargingReply payment(ChargingRequest request, BillingAccount billing) {
        ...
        if (request.isRoaming()) {
            Pair<ChargingReply , Double> pair= getBucketCharged(billing.getBucket3(), disccounts, priceRoaming, rsu, request);
            ...
            Pair<ChargingReply , Double> pair= getBucketCharged(billing.getBucket1(), disccounts, normalPrice, rsu, request);
            billing.setBucket1(pair.b);
